...
urlpatterns = [
    ...
    path('mi-lealtad/', MiLealtadView.as_view(), name='mi-lealtad'),
    path('lealtad/previsualizar/', LoyaltyPreviewView.as_view(), name='lealtad-previsualizar'),
    path('lealtad/config/', LoyaltyConfigView.as_view(), name='lealtad-config'),
